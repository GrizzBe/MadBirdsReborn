...
bool gameWorld::MainLoop(sf::RenderWindow& _window) // Warning is a non-issue.
{
    ...
    return m_bWinning; // Return boolean indicating whether or not it should restart.
}
