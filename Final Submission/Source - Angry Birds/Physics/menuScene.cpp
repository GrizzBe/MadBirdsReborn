...
void menuScene::MainLoop(sf::RenderWindow& _window)
{
    ...
    m_MenuBG = new sf::Sprite(*m_MenuBGTexture); // Create background
...
{
    for (auto i : m_Buttons) // Check buttons
    {
...
void menuScene::Render(sf::RenderWindow& _window)
{
    ...
    _window.draw(*m_MenuBG); // Draw background
    for (auto i : m_Buttons) // Draw buttons
    {
